...
// need to know about input specifics to this gameobject.
	...
	public class Gaze_VRInteractiveItem : MonoBehaviour
    {
    [SerializeField]
    ...
    void LateUpdate() {
        if (transform.Find("Dropdown List")) {
            ...
            foreach (Transform _child in Children) {
				if (!_child.GetComponent<Gaze_VRInteractiveItem>() && _child.GetComponent<Toggle>()) {
					_child.gameObject.AddComponent<Gaze_VRInteractiveItem>();
                }
            }
